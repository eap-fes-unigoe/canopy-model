...
out_4 %>%
  ...
  labs(x = "Zenith (deg)", y = "Fraction of total radiation absorbed", title="Fraction of abosorbed radiation with different zenith")
```
...
The model has been implement in the simplest possible way.

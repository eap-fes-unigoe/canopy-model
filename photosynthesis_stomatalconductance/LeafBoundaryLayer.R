# function [flux] = LeafBoundaryLayer (state_last,met,pars)
...
# -------------------------------------------------------------------------
  # Input
#   pars$grav      ! Gravitational acceleration (m/s2)
#   pars$tfrz      ! Freezing point of water (K)
#   pars$visc0     ! Kinematic viscosity at 0C and 1013.25 hPa (m2/s)
#   pars$Dh0       ! Molecular diffusivity (heat) at 0C and 1013.25 hPa (m2/s)
#   pars$Dv0       ! Molecular diffusivity (H2O) at 0C and 1013.25 hPa (m2/s)
#   pars$Dc0       ! Molecular diffusivity (CO2) at 0C and 1013.25 hPa (m2/s)
#   met$patm        ! Atmospheric pressure (Pa)
#   met$rhomol      ! Molar density mol/m3)
#   met$wind        ! Wind speed (m/s)
#   met$tair        ! Air temperature (K)
#   pars$dleaf        ! Leaf dimension (m)

...
The following chunks of code are taken from the Photosynthesis tests_loop script, based on the main script. Frist some preparatory code:
just load example results to demonstrate code? maybe...
```{r}
# Setting some time unit variables in unit seconds
dt <- 3600 # delta time: model time step 3600 sec = 1h
